            ...
            <div className="p-4 bg-white rounded-lg shadow-md">
                ...
                <Box sx={{ width: '100%' }}>
                    <Tabs value={tabIndex} onChange={handleTabChange} indicatorColor="primary" variant="scrollable" scrollButtons="auto" textColor="inherit" sx={{ backgroundColor: '#F5F5FF', '& .MuiTabs-indicator': { backgroundColor: '#0000FF' }, '& .MuiTab-root': { color: '#424242', textTransform: 'capitalize', whiteSpace: 'normal', lineHeight: 1.2, minHeight: 'auto', }, '& .Mui-selected': { color: '#0000FF' } }}>
                        <Tab label="General product metadata" />
                        <Tab label="Product parameters" />
                        {/* <Tab label="Other Charges" />
                            <Tab label="Timely Repayment Incentives" /> */}
                        <Tab label="Eligibility criteria" />
                        <Tab label="Credit bureau parameters configuration" />
                        <Tab label="Financial statement parameters" />
                    ...
                    <Box mt={3}>
                        ...
                        {tabIndex === 1 && <ProductParameters handleTabChange={handleTabChange} tabIndex={tabIndex} setTabIndex={setTabIndex} />}
                        ...
                        {tabIndex === 2 && <EligibilityCriteria handleTabChange={handleTabChange} tabIndex={tabIndex} setTabIndex={setTabIndex} />}
                        {tabIndex === 3 && <CreditBureauParametersConfiguration handleTabChange={handleTabChange} tabIndex={tabIndex} setTabIndex={setTabIndex} />}
                        {tabIndex === 4 && <FinancialStatementParameters handleTabChange={handleTabChange} tabIndex={tabIndex} setTabIndex={setTabIndex} />}
