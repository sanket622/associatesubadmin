...
// import CreditCriteria from './createvarient/CreditCriteria';
    ...
    return (
        <div className="p-4 bg-white rounded-lg shadow-md">
            ...
            <Box sx={{ width: '100%' }}>
                ...
                <Box mt={3}>
                    {tabIndex === 0 && <BasicInformation handleTabChange={handleTabChange} tabIndex={tabIndex} setTabIndex={setTabIndex} totalTabs={totalTabs} status={status} />}
                    {tabIndex === 1 && <VariantParameters handleTabChange={handleTabChange} tabIndex={tabIndex} setTabIndex={setTabIndex} totalTabs={totalTabs} status={status} />}
                    ...
                    {/* {tabIndex === 3 && <TimelyRepaymentIncentives handleTabChange={handleTabChange} tabIndex={tabIndex} setTabIndex={setTabIndex} totalTabs={totalTabs} />} */}
                    {/* {tabIndex === 4 && <CreditCriteria handleTabChange={handleTabChange} tabIndex={tabIndex} setTabIndex={setTabIndex} totalTabs={totalTabs} />} */}
                </Box>
            </Box>
        </div>
    );
