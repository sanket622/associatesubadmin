...
import { fetchProductDetails, fetchProducts, setPage, setRowsPerPage } from '../../../redux/masterproduct/tableslice/productsSlice';
...
const MasterProductTable = () => {
  ...
  return (
    <>
      <div className="p-6">
        <h1 className="text-[24px] font-semibold mb-4">Master Products</h1>
